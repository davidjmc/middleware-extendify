...
import ComponentsCollection from './ComponentsCollection.js';
...
export default class Thing {
    ...
    adl() {
        ...
        //const adlFilePath = path.join(currentDir, 'adl.template');

        let adl = fs.readFileSync(path.join(currentDir, 'adl.template')).toString()
        /* @TODO - remove this */
        if (this.isNewModel) {
            adl = fs.readFileSync(path.join(currentDir, 'adl.template')).toString()
        }
        /* END*/
    ...
    configuration(options = {}) {
        ...
        let configuration = fs.readFileSync(path.join(currentDir, "configurations.template")).toString()
